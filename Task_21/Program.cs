...
System.Console.Write("Введи координаты Az: ");

double Az = Convert.ToInt32(Console.ReadLine());


System.Console.Write("Введи координаты Bz: ");

double Bz = Convert.ToInt32(Console.ReadLine());



double distance = Math.Round(Math.Sqrt(Math.Pow(Bx - Ax, 2) + Math.Pow(By - Ay, 2) + Math.Pow (Bz - Az, 2)), 3);
